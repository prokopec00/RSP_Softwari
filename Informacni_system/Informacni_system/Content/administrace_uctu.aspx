...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p class="auto-style1">
        Úprava záznamů:</p>
    <p class="auto-style1">
        Identifikační číslo záznamu:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="id_show" runat="server" OnTextChanged="id_show_TextChanged" Width="77px" ToolTip="první záznam má id 36"></asp:TextBox>
